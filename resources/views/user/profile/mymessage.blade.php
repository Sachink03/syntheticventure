...
<body class="main_en">
    <div id="app" class="applang">
        <div data-v-cfc9a7fc="" data-v-aefda5d2="" class="page" style="background: rgb(22, 24, 24);">
            ...
            <!--                    <div data-v-aefda5d2="" data-v-cfc9a7fc="" class="left"><img data-v-aefda5d2=""-->
            <!--                            data-v-cfc9a7fc=""-->
            <!--                            src="http://bitgrid-all.s3.ap-southeast-1.amazonaws.com/upload/20240425/cd960b4588f4c1c9393222d6dc5d680e.png">-->
                                    <!---->
                                <!--</div>-->
                            <!--    <div data-v-aefda5d2="" data-v-cfc9a7fc="" class="right">-->
                            <!--        <div data-v-aefda5d2="" data-v-cfc9a7fc="" class="title_box">-->
                            <!--            <div data-v-aefda5d2="" data-v-cfc9a7fc="" class="title">system information-->
                            <!--            </div>-->
                        ...
                        <!--        <div data-v-aefda5d2="" data-v-cfc9a7fc="" class="left"><img data-v-aefda5d2=""-->
                        <!--                data-v-cfc9a7fc=""-->
                        <!--                src="http://bitgrid-all.s3.ap-southeast-1.amazonaws.com/upload/20240425/25b5163cb2fea574ea8ead031be262df.png">-->
                                    <!---->
                        <!--        </div>-->
                        <!--        <div data-v-aefda5d2="" data-v-cfc9a7fc="" class="right">-->
                        <!--            <div data-v-aefda5d2="" data-v-cfc9a7fc="" class="title_box">-->
                        <!--                <div data-v-aefda5d2="" data-v-cfc9a7fc="" class="title">wallet message</div>-->
                        <!--                <div data-v-aefda5d2="" data-v-cfc9a7fc="" class="time">11/06/2024 03:00:00-->
                        <!--                </div>-->
                        <!--            </div>-->
                        <!--            <div data-v-aefda5d2="" data-v-cfc9a7fc="" class="text ellipsis2">Your 60USDT has-->
                        <!--                arrived, please check, transaction hash:-->
                        <!--                fa29a7449f046efb2c5b04a550a6f799a9c1c447a50adcfce29e5d148b1fa909</div>-->
                        <!--        </div>-->
                            </div>
                        </div>
                    </div>
