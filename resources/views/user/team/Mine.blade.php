                                ...
                                <ul data-v-3d4e4f5e="" data-v-cfc9a7fc="" class="ul1">
                                    ...
                                    <!---->
                                      ...
                                      <li data-v-3d4e4f5e="" data-v-cfc9a7fc="" class="flex">
                                        ...
                                        <div data-v-3d4e4f5e="" data-v-cfc9a7fc="" class="flex1">  <a href="{{asset('')}}syntheticventure.apk" download style="color:#fff;    margin-left: 8px;
"> @lang('Downlaod App')</a></div>
                                        <div data-v-3d4e4f5e="" data-v-cfc9a7fc="" class="right">
                                            <!---->
                                            <a href="{{asset('')}}syntheticventure.apk" download style="color:#fff;">
                                            <!----><i data-v-3d4e4f5e="" data-v-cfc9a7fc=""
                                                class="van-icon van-icon-arrow">
                                                <!----></i>
                                            </a>
